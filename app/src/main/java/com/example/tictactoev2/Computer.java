...
/*
    Button mark;
    public boolean checkPreWinState(){
        ...
        for (int i = 0; i < 3; i++){
            if (buttons[i][i].getText().equals("X"))
                countX++;
            else if (buttons[i][i].getText().equals("O"))
                countO++;
            else {
                space++;
                mark = buttons[i][i];
        ...
        // diagonal 2 no work
        for (int i = 2; i >= 0; i--){
            if (buttons[2-i][i].getText().equals("X"))
                countX++;
            else if (buttons[2-i][i].getText().equals("O"))
                countO++;
            else {
                space++;
                mark = buttons[2-i][i];
